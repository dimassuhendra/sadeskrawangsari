...
<style>
    ...
    @media (max-width: 768px) {
        ...
        /* Styling khusus agar konten teks tidak terlalu mepet ke kiri */
        .table-responsive-stack td>* {
            flex: 1;
        }
    }
                ...
                <table class="table table-hover table-responsive-stack">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Opsi">
                                <a href="#" class="btn btn-sm btn-primary w-100-mobile">
    ...
    <div class="col-md-4">
        <div class="content-section">
            ...
            <div class="activity-feed">
                {{-- Contoh iterasi log --}}
                @foreach($logs as $log)
                <div style="border-left: 2px solid #eee; padding-left: 15px; margin-bottom: 20px; position: relative;">
                    <div
                    ...
                    <p class="mb-0" style="font-size: 9px;">{{ $log->pesan }}</p>
                </div>
                @endforeach
            </div>
        </div>
