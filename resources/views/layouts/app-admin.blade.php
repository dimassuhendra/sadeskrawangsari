    ...
    <style>
        ...
        @media (max-width: 992px) {
            ...
            .main-content {
                margin-left: 0;
                padding-top: 80px;
                /* Jarak untuk mobile navbar */
            }

            /* Saat Sidebar Terbuka di HP */
...
<body>
    <div class="mobile-navbar">
        <div class="d-flex align-items-center gap-2">
            <img src="{{ asset('img/mainLogo.png') }}" width="35" alt="Logo">
            <span style="font-family: 'Domine'; font-size: 16px; font-weight: 700;">ADMIN PANEL</span>
        </div>
        <button class="hamburger-btn" id="btnToggle">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnToggle, #overlay').on('click', function() {
                toggleSidebar();
            });

            // Tutup sidebar otomatis jika link diklik (khusus mobile)
